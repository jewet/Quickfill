  ...
  return (
    <SafeAreaView style={accessoriesStyles.accessoriesContainer}>
      ...
      <ScrollView
        ...
        <Text style={complaintsStyles.firstText}>Let us know how we can improve</Text>
        <Text style={complaintsStyles.secondText}>There is always room for <Text style={complaintsStyles.greenText}>improvement!</Text></Text>
        <Text style={complaintsStyles.secondText}>Tell us about your experience so far or how we can make Mohgas better for you.</Text>
