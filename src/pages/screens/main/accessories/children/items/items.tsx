  ...
  return (
    <SafeAreaView style={accessoriesStyles.accessoriesContainer}>
      ...
      <View
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={itemsStyles.topScrollView}>
        ...
        <ScrollView
          ...
          {items_data.map((data, index) => (
            <TouchableOpacity
              key={index}
              style={[orderDetailsStyles.flexContainer, itemsStyles.itemsCont]} onPress={()=>handleNavigation(data)}>
              <View
                style={[
