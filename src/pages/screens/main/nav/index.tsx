...
function Main() {
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused }) => {
          ...
          if (route.name === 'home') {
            IconComponent = focused ? <ActiveHomeIcon width={24} height={24} fill='none' /> : <HomeIcon width={24} height={24} fill='none' />;
          } else if (route.name === 'accessories') {
            IconComponent = focused ? <ActiveAccessoriesIcon width={24} height={24} fill='none' /> : <AccessoriesIcon width={24} height={24} fill='none' />;
          } else if (route.name === 'orders') {
            IconComponent = focused ? <ActiveOrderIcon width={24} height={24} fill='none' /> : <OrderIcon width={24} height={24} fill='none' />;
          } else if (route.name === 'profile') {
            IconComponent = focused ? <ActiveProfileIcon width={24} height={24} fill='none' /> : <ProfileIcon width={24} height={24} fill='none' />;
          }
    ...
    >
      ...
      <Tab.Screen name="accessories" component={Accessories} options={{ tabBarLabel: 'Accessories' }} />
